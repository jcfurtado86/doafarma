 ...
 */
function SearchableSelectInner<T extends FieldValues>(
  {
    formProps,
    placeholder,
    cities,
...
const SearchableSelectBase = forwardRef(SearchableSelectInner);
SearchableSelectBase.displayName = 'SearchableSelect';

const SearchableSelect = SearchableSelectBase as unknown as <T extends FieldValues>(
  props: SearchableSelectProps<T> & React.RefAttributes<SearchableSelectRef>
